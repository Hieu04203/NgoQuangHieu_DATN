...
function Courses() {
  ...
  if (!courses.length) return (
      <div className="flex flex-col items-center justify-center min-h-screen">
        <h3 className="text-xl font-semibold text-gray-700">Không tìm thấy quảng cáo nào</h3>
        <p className="text-gray-500 mt-2">Vui lòng thử các bộ lọc khác hoặc kiểm tra lại sau.</p>
      </div>
  );
