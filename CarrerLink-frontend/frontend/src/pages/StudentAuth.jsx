    ...
    const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (response.token) {
                ...
                setError(response.message || "Thông tin đăng nhập không hợp lệ. Vui lòng thử lại.");
            }
        } catch (error) {
        ...
        <div className="min-h-[calc(100vh-4rem)] flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-md w-full">
                <div className="text-center mb-8">
                    <h2 className="text-3xl font-bold text-gray-900">Đăng nhập ứng viên</h2>
                    <p className="mt-2 text-gray-600">Chào mừng bạn trở lại CareerLink</p>
                </div>
