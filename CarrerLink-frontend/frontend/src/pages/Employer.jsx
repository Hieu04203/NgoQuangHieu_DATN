...
function Employer() {
  ...
  if (loading) return <div className="min-h-screen bg-gray-50 p-8">Đang tải...</div>;
  if (!company) return <div className="min-h-screen bg-gray-50 p-8">Không tìm thấy công ty</div>;
