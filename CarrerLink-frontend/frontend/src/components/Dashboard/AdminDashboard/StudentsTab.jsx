...
export default function StudentTab() {
    ...
    useEffect(() => {
        getAllStudents()
            ...
            .catch(error => {
                setError("Không tải được dữ liệu ứng viên.");
                setLoading(false);
            });
    }, []);
    ...
    if (loading) {
        return (
            <div className="flex items-center justify-center min-h-[400px]">
                ...
                <span className="ml-2 text-gray-600">Đang tải ứng viên...</span>
            </div>
        );
    }
                                ...
                                <div className="space-y-4">
                                    <div className="bg-gray-50 p-4 rounded-lg">
                                        ...
                                        <div className="space-y-2">
                                            <p><span className="font-medium">Trường đại học:</span> {selectedStudent.university}</p>
                                            <p><span className="font-medium">Bằng cấp:</span> {selectedStudent.degree}</p>
                                            <p><span className="font-medium">Ngành:</span> {selectedStudent.department}</p>
