...
const TechnologyManagement = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (response.success) {
            ...
            setTechName('');
            Swal.fire('Thành công!', 'Công nghệ đã được thêm vào thành công', 'Thành công');
        } else {
    ...
    return (
        <div className="bg-white rounded-2xl shadow-sm p-6">
            <h2 className="text-2xl font-bold text-gray-800 mb-6">Quản lý công nghệ</h2>
            ...
            <form onSubmit={handleSubmit} className="flex gap-4 mb-6">
                ...
                >
                    <Plus size={20} className="mr-2" /> Thêm Công nghệ
                </button>
            </form>
