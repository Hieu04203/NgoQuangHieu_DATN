  ...
  if (!Array.isArray(projects)) {
    ...
    return (
      <div className="w-full p-6 bg-red-50 border border-red-200 rounded-lg">
        <p className="text-red-600">Lỗi: Định dạng dữ liệu dự án không hợp lệ</p>
      </div>
    );
  }
    ...
    <div className="w-full bg-white p-6 shadow-lg rounded-lg">
      ...
      {allEmpty ? (
        <div className="text-center py-8">
          <p className="text-gray-500">Không có dự án nào có sẵn tại thời điểm này.</p>
        </div>
      ) : (
            ...
            <div key={difficultyLevels[index]} className="flex flex-col">
              ...
              {projects.length > 0 ? (
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  Không có dự án {difficultyLevels[index].toLowerCase()}
                  nào khả dụng
                  </p>
                </div>
              )}
  ...
  return (
    <div className="bg-gray-50 hover:bg-gray-100 p-4 rounded-lg transition-colors border border-gray-200">
      ...
      {project.technologies?.length > 0 && (
        <div className="mt-3">
          <p className="text-xs font-medium text-gray-500">Công nghệ:</p>
