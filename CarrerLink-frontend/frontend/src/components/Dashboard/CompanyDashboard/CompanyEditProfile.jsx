...
function CompanyEditProfile() {
    ...
    if (!company) return <div>Đang tải...</div>;

    return (
        <div className="max-w-4xl mx-auto p-8">
            <h2 className="text-2xl font-bold text-gray-900 mb-8">Chỉnh sửa hồ sơ công ty</h2>
            <div className="bg-white items-center rounded-xl shadow-sm p-8">
                ...
                <form onSubmit={handleSubmit} className="space-y-6">
                    <div className="space-y-4">
                        ...
                        {/* Technologies */}
                        <div className="space-y-4">
                            <h3 className="text-lg font-semibold">Công nghệ</h3>
                            <select
