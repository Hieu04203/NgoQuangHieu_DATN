    ...
    return (
        <div className="flex flex-col bg-white shadow-md rounded-lg p-6 w-60 max-w-sm">
          ...
          <div className="flex items-center">
            ...
            <div className="ml-4">
              <h2 className="text-xl font-semibold text-gray-800">Các quảng cáo đã truy cập</h2>
              <p className="text-gray-500 text-sm">Theo dõi tiến trình của bạn</p>
            </div>
          </div>
          ...
          <div className="mt-4">
            ...
            <p className="text-gray-500">Các quảng cáo đã xem</p>
          </div>
